...
const Content = () => {
    const contents = [
      {
        ...
        image1: (
          <svg
            ...
            class="lucide lucide-cloud-upload text-primary w-8 h-8"
          >
        ...
        desc: "Use internee.pk to share tutorials,exercises and projects. Help others learn while you grow with virtual interships that reward your skills",
        ...
        out: (
          <svg
            ...
            stroke-linecap="round"
            stroke-linejoin="round"
            class="lucide lucide-chevron-right h-4 w-4 ml-1 text-pri"
          >
      ...
      },
      {
        ...
        image1: (
          <svg
            ...
            stroke-linecap="round"
            stroke-linejoin="round"
            class="lucide lucide-dollar-sign text-primary w-8 h-8"
          >
      ...
      },
      {
        ...
        image1: (
          <svg
            ...
            stroke-linecap="round"
            stroke-linejoin="round"
            class="lucide lucide-user-check text-[#43A724] w-8 h-8"
          >
      ...
      },
      {
        ...
        image1: (
          <svg
            ...
            stroke-linecap="round"
            stroke-linejoin="round"
            class="lucide lucide-handshake text-primary w-8 h-8"
          >
        ...
        desc: "We Keep it transparent. Join internee.pk and benefit from a fair model that pays you well - all while gaining experience in virtual interships",
  ...
  return (
    <div className="w-ful h-screen py-20 ">
      ...
      <div className="flex justify-center items-center py-8">
        <div className="bg-primary px-7 py-3 text-white font-semibold text-xl rounded-xl ">
          Start Teaching Today
        </div>
      </div>
      <div className="w-5xl mx-auto">
        <div className="grid md:grid-cols-2 grid-cols-1 shadow  gap-10 rounded-2xl ">
          {contents.map((content, index) => {
            return (
              <div key={content.id} className=" p-10 rounded-2xl shadow-2xl">
                <div className="flex">
                  <div className="bg-bg-primary px-4 py-3 rounded-xl">
