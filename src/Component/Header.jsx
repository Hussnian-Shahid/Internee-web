    ...
    <>
      <div className="flex md:px-16.5 pt-10 px-4 ">
        <div className="flex justify-center  flex-col md:w-full ">
          ...
          <div className="md:text-[20px] md:text-start  py-5 text-center ">
          ...
          <div className="flex md:flex-row flex-col items-center gap-5 ">
            <button className="cursor-pointer bg-primary text-white md:px-5 md:py-4  md:text-[22px] px-8 py-3 font-sans rounded-xl hover:bg-secondry  border-[1px] border-primary transition-all duration-300   ">
              Our Job Portal
            </button>
            <div className="cursor-pointer bg-[#213448] text-white md:px-5 md:py-4  md:text-[22px] px-8 py-3 rounded-xl hover:bg-[#547792] hover:text-white flex justify-center items-center  transition-all duration-300 gap-2 ">
